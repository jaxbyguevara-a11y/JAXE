...
import com.aistudio.lookia.ui.LookIAViewModel
import com.aistudio.lookia.ui.LookIAViewModelFactory
import com.aistudio.lookia.ui.components.AddGarmentDialog
import com.aistudio.lookia.ui.components.FeedbackSurveyDialog
import com.aistudio.lookia.ui.screens.AhorroScreen
import com.aistudio.lookia.ui.screens.ClosetScreen
import com.aistudio.lookia.ui.screens.CommunityScreen
import com.aistudio.lookia.ui.screens.HomeScreen
import com.aistudio.lookia.ui.screens.ProbadorAvatarScreen
import com.aistudio.lookia.ui.screens.VestirmeScreen
...
import com.aistudio.lookia.ui.theme.LookIATheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val repository = (application as LookIAApplication).repository

        setContent {
            LookIATheme {
                val viewModel: LookIAViewModel = viewModel(
                    factory = LookIAViewModelFactory(repository)
                )
                LookIAMainApp(viewModel = viewModel)
            }
        }
    }
}
...
@Composable
fun LookIAMainApp(viewModel: LookIAViewModel) {
