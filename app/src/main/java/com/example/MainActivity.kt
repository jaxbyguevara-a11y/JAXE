...
import com.example.ui.LookIAViewModel
import com.example.ui.LookIAViewModelFactory
import com.example.ui.components.AddGarmentDialog
import com.example.ui.components.FeedbackSurveyDialog
import com.example.ui.screens.AhorroScreen
import com.example.ui.screens.ClosetScreen
import com.example.ui.screens.CommunityScreen
import com.example.ui.screens.HomeScreen
import com.example.ui.screens.ProbadorAvatarScreen
import com.example.ui.screens.VestirmeScreen
...
import com.example.ui.theme.LookIATheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val repository = LookIARepository(
...
fun LookIAMainApp(viewModel: LookIAViewModel) {
    ...
    var activeTab by remember { mutableStateOf(0) } // 0: Inicio, 1: Vísteme, 2: Probador, 3: Clóset, 4: Ahorro, 5: Comunidad
    ...
    feedbackTargetOutfit?.let { outfit ->
        FeedbackSurveyDialog(
            outfit = outfit,
            onDismiss = { feedbackTargetOutfit = null },
