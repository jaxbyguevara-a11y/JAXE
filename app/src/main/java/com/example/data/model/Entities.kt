...
data class AvatarProfile(
    @PrimaryKey
    val id: Int = 1,
    val userName: String = "Camila",
    val creationMethod: String = "manual", // "manual" or "scan"
    ...
    val hasScanConsent: Boolean = true,
    val isPrivateAccount: Boolean = true,
    val scanFrontPhoto: String = "",
    val scanProfilePhoto: String = "",
    val scanBackPhoto: String = ""
)
